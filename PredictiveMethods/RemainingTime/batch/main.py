...
test = pd.read_csv("../../data/test_%s.csv" % dataset, sep=",", encoding="utf-8")
...
predictive_monitor.test(test, output_filename="output_%s_%s_%s_%s.csv" % (dataset,cls_method,dataset_params.n_estimators[dataset],dataset_params.learning_rate[dataset]))
