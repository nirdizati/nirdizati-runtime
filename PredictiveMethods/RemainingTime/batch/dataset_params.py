...
dynamic_cols[dataset] = ["activity_name", "monitoringResource", "question", "Resource", "duration", "hour", "remtime"]
...
dynamic_cols[dataset] = ["FirstWithdrawalAmount", "NumberOfTerms", "OfferedAmount", "activity_duration",
                         "activity_name", "Resource", "Action", "CreditScore", "EventOrigin", "hour", "remtime"]
